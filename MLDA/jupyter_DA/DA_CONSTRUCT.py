...
# +
# read the data
data_input = pd.read_excel('/home/jesper/Work/MLDA_app/MLDA/input_data/constructed_data_RF_interpolation_test.xlsx')
...
# save_object(object_to_save=da_dict, filename='da_dict_CONSTRUCT') # comment out when created and saved

# load data analysis dict
da_dict = load_object('da_dict_CONSTRUCT.sav')
da_dict
