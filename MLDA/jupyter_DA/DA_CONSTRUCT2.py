...
# +
# read the data
data_input = pd.read_excel('/home/jesper/Work/MLDA_app/MLDA/input_data/constructed_data_RF_interpolation_test2.xlsx')
...
choose_var = [0,1,2,3] # First column: 0
...
# save_object(object_to_save=data, filename='constructed_data')

constructed_data = load_object('constructed_data.sav')
constructed_data
# -
...
# save_object(object_to_save=da_dict, filename='da_dict_CONSTRUCT2') # comment out when created and saved

# load data analysis dict
da_dict = load_object('da_dict_CONSTRUCT2.sav')
da_dict
